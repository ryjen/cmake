...
function(add_valgrind_test)
	set(options)
	set(singleValueOpts TARGET EXECUTABLE ENABLE_MEMCHECK)
	...
	if (NOT ADD_VALGRIND_TEST_ENABLE_MEMCHECK OR NOT VALGRIND_COMMAND)
...
function(add_valgrind_profile)
	set(options)
	set(singleValueOpts TARGET EXECUTABLE ENABLE_PROFILING)
	set(multiValueOpts VALGRIND_ARGS EXECUTABLE_ARGS)
	...
	if (NOT ADD_VALGRIND_PROFILE_ENABLE_PROFILING OR NOT VALGRIND_COMMAND)
...
function(add_valgrind_profile_test)
	set(options)
	set(singleValueOpts TARGET EXECUTABLE ENABLE_PROFILING ENABLE_MEMCHECK)
	set(multiValueOpts VALGRIND_ARGS EXECUTABLE_ARGS)
	...
	if (ADD_VALGRIND_PROFILE_TEST_ENABLE_PROFILING) 
		add_valgrind_profile(ADD_VALGRIND_PROFILE_TEST_ENABLE_PROFILING TARGET ${ADD_VALGRIND_PROFILE_TEST_TARGET} EXECUTABLE ${ADD_VALGRIND_PROFILE_TEST_EXECUTABLE})
	else()
		add_valgrind_test(ADD_VALGRIND_PROFILE_TEST_ENABLE_MEMCHECK TARGET ${ADD_VALGRIND_PROFILE_TEST_TARGET} EXECUTABLE ${ADD_VALGRIND_PROFILE_TEST_EXECUTABLE})
	endif()
