...
function(add_valgrind_test _targetname _testrunner)
	...
	if (NOT VALGRIND_COMMAND)
		...
		add_test(${_targetname} ${VALGRIND_COMMAND} --leak-check=full --error-exitcode=5 ${ARGV2} --quiet ${_testrunner} ${ARGN})
	endif()
...
function(add_valgrind_profile _targetname _testrunner)
	...
	if (NOT VALGRIND_COMMAND)
		...
		add_test(${_targetname} ${VALGRIND_COMMAND} --tool=callgrind --error-exitcode=5 ${ARGV2} --quiet ${_testrunner} ${ARGN})
	endif()
...
function(add_opt_valgrind_test _cond _targetname _testrunner)
  ...
  if (NOT ${_cond} OR NOT VALGRIND_COMMAND)
    ...
    add_test(${_targetname} ${VALGRIND_COMMAND} --leak-check=full --error-exitcode=5 ${ARGV3} --quiet ${_testrunner} ${ARGN})
  endif()
...
function(add_opt_valgrind_profile _cond _targetname _testrunner)
  ...
  if (NOT ${_cond} OR NOT VALGRIND_COMMAND)
    ...
    add_test(${_targetname} ${VALGRIND_COMMAND} --tool=calgrind --error-exitcode=5 ${ARGV3} --quiet ${_testrunner} ${ARGN})
  endif()
