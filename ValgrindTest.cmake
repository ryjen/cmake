...
function(add_valgrind_profile_test ENABLE_PROFILING ENABLE_MEMCHECK)
	set(options "")
	set(singleValueOpts TARGET EXECUTABLE)
	set(multiValueOpts VALGRIND_ARGS EXECUTABLE_ARGS)
	...
	if (${ENABLE_PROFILING}) 
		add_valgrind_profile(${ENABLE_PROFILING} TARGET ${ADD_VALGRIND_PROFILE_TEST_TARGET} EXECUTABLE ${ADD_VALGRIND_PROFILE_TEST_EXECUTABLE})
	else()
		add_valgrind_test(${ENABLE_MEMCHECK} TARGET ${ADD_VALGRIND_PROFILE_TEST_TARGET} EXECUTABLE ${ADD_VALGRIND_PROFILE_TEST_EXECUTABLE})
	endif()
