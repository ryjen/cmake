...
function(add_valgrind_profile_test)
	...
	if (ADD_VALGRIND_PROFILE_TEST_PROFILING) 
		add_valgrind_profile(PROFILING ${ADD_VALGRIND_PROFILE_TEST_PROFILING} TARGET ${ADD_VALGRIND_PROFILE_TEST_TARGET} EXECUTABLE ${ADD_VALGRIND_PROFILE_TEST_EXECUTABLE})
	else()
		add_valgrind_test(MEMCHECK ${ADD_VALGRIND_PROFILE_TEST_MEMCHECK} TARGET ${ADD_VALGRIND_PROFILE_TEST_TARGET} EXECUTABLE ${ADD_VALGRIND_PROFILE_TEST_EXECUTABLE})
	endif()
